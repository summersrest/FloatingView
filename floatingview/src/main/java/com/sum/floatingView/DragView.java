...
//        distanceLeft = typedArray.getDimensionPixelSize(R.styleable.DragView_dv_margin_start, 0);
//        distanceRight = typedArray.getDimensionPixelSize(R.styleable.DragView_dv_margin_end, 0);
//        distanceTop = typedArray.getDimensionPixelSize(R.styleable.DragView_dv_margin_top, 0);
//        distanceBottom = typedArray.getDimensionPixelSize(R.styleable.DragView_dv_margin_bottom, 0);
//        if (distanceLeft == 0 && distanceRight == 0 && distanceTop == 0 && distanceBottom == 0) {
//            distanceLeft = typedArray.getDimensionPixelSize(R.styleable.DragView_dv_margin, dp2px(DISTANCE_DEFAULT));
//            distanceRight = typedArray.getDimensionPixelSize(R.styleable.DragView_dv_margin, dp2px(DISTANCE_DEFAULT));
//            distanceTop = typedArray.getDimensionPixelSize(R.styleable.DragView_dv_margin, dp2px(DISTANCE_DEFAULT));
//            distanceBottom = typedArray.getDimensionPixelSize(R.styleable.DragView_dv_margin, dp2px(DISTANCE_DEFAULT));
//        }
//
//        layoutParams = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT, FrameLayout.LayoutParams.WRAP_CONTENT);
//        layoutParams.gravity = typedArray.getInteger(R.styleable.DragView_dv_gravity, Gravity.START);
